...
class InteractingMixtureLikelihood(Likelihood):
    @staticmethod
    def evaluate(z, likelihood, *args):
        pass
    ...
    def update_indicators(z, natural_parameters, likelihood, *args):
        ...
        assert natural_parameters.shape == proba.shape, "shape %s of the natural parameter " \
            "associated with the mean must match the shape %s of the expected indicators" % \
